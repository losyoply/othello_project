...
public:
   ...
   if(board[0][1]==1&&board[0][0]!=1) b_total -=15;
    if(board[1][1]==1&&board[0][0]!=1) b_total -=15;
    if(board[1][0]==1&&board[0][0]!=1) b_total -=15;
    if(board[6][0]==1&&board[7][0]!=1) b_total -=15;
    if(board[6][1]==1&&board[7][0]!=1) b_total -=15;
    if(board[7][1]==1&&board[7][0]!=1) b_total -=15;
    if(board[0][6]==1&&board[7][7]!=1) b_total -=15;
    if(board[1][6]==1&&board[7][7]!=1) b_total -=15;
    if(board[1][7]==1&&board[7][7]!=1) b_total -=15;
    if(board[6][6]==1&&board[7][7]!=1) b_total -=15;
    if(board[6][7]==1&&board[7][7]!=1) b_total -=15;
    if(board[7][6]==1&&board[7][7]!=1) b_total -=15;

    if(board[0][1]==2&&board[0][0]!=2) w_total -=15;
    if(board[1][1]==2&&board[0][0]!=2) w_total -=15;
    if(board[1][0]==2&&board[0][0]!=2) w_total -=15;
    if(board[6][0]==2&&board[7][0]!=2) w_total -=15;
    if(board[6][1]==2&&board[7][0]!=2) w_total -=15;
    if(board[7][1]==2&&board[7][0]!=2) w_total -=15;
    if(board[0][6]==2&&board[7][7]!=2) w_total -=15;
    if(board[1][6]==2&&board[7][7]!=2) w_total -=15;
    if(board[1][7]==2&&board[7][7]!=2) w_total -=15;
    if(board[6][6]==2&&board[7][7]!=2) w_total -=15;
    if(board[6][7]==2&&board[7][7]!=2) w_total -=15;
    if(board[7][6]==2&&board[7][7]!=2) w_total -=15;
